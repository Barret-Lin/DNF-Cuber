...
async function run() {
  const queries = [
    'Square-1 CSP tutorial Rubik',
    'Skewb Sarah Advanced tutorial Rubik',
    'Clock 7-Simul tutorial Rubik',
    '3x3 Blindfolded 3-Style tutorial Rubik',
    '3x3 FMC Domino Reduction tutorial Rubik'
  ];
