...
const tutorials = [
  ...
  { id: '444', title: '4x4x4 降階法', puzzle: '4x4x4 Cube', steps: [{name: '中心', desc: '完成六面中心。'}, {name: '組邊', desc: '將邊塊兩兩配對。'}, {name: '3x3階段', desc: '視為3x3解原，並處理特殊情況(Parity)。'}], videoId: '7Ron6MN45LY' },
  { id: '555', title: '5x5x5 降階法', puzzle: '5x5x5 Cube', steps: [{name: '中心', desc: '完成3x3中心區塊。'}, {name: '組邊', desc: '將邊塊三三配對。'}, {name: '3x3階段', desc: '視為3x3解原。'}], videoId: 'R0yOKEQCRMQ' },
  { id: '666', title: '6x6x6 降階法', puzzle: '6x6x6 Cube', steps: [{name: '中心', desc: '完成4x4中心區塊。'}, {name: '組邊', desc: '將邊塊四四配對。'}, {name: '3x3階段', desc: '處理Parity並解原。'}], videoId: '7Ron6MN45LY' },
  { id: '777', title: '7x7x7 降階法', puzzle: '7x7x7 Cube', steps: [{name: '中心', desc: '完成5x5中心區塊。'}, {name: '組邊', desc: '將邊塊五五配對。'}, {name: '3x3階段', desc: '視為3x3解原。'}], videoId: 'R0yOKEQCRMQ' },
  { id: '333bf', title: '3x3x3 盲解 (OP法)', puzzle: '3x3x3 Blindfolded', steps: [{name: '編碼', desc: '將角塊與邊塊位置轉換為英文字母。'}, {name: '記憶', desc: '利用聯想法記憶字母順序。'}, {name: '執行', desc: '戴上眼罩，使用Old Pochmann公式逐一復原。'}], videoId: '7Ron6MN45LY' },
  { id: '333fm', title: '3x3x3 最少步數基礎', puzzle: '3x3x3 Fewest Moves', steps: [{name: 'Blockbuilding', desc: '不拘泥於層先，優先建立2x2x2區塊。'}, {name: 'F2L-1', desc: '擴展至前兩層減一槽。'}, {name: 'LL', desc: '使用最少步數公式解決頂層。'}], videoId: 'R0yOKEQCRMQ' },
  { id: '333oh', title: '3x3x3 單手基礎', puzzle: '3x3x3 One-Handed', steps: [{name: '握法', desc: '使用左手小指與無名指支撐。'}, {name: '指法', desc: '練習單手撥動 U、R 層。'}, {name: '公式轉換', desc: '避免需要大量 F 或 B 轉動的公式。'}], videoId: '7Ron6MN45LY' },
  { id: 'clock', title: '魔錶基礎解法', puzzle: 'Clock', steps: [{name: '十字', desc: '將一面四個邊的指針與中心對齊。'}, {name: '角針', desc: '將四個角的指針對齊。'}, {name: '翻面', desc: '翻面重複上述步驟。'}], videoId: 'R0yOKEQCRMQ' },
  { id: 'megaminx', title: '五魔方基礎解法', puzzle: 'Megaminx', steps: [{name: '白色星形', desc: '完成底面五個邊塊。'}, {name: 'F2L', desc: '完成底層角塊與第二層邊塊。'}, {name: 'S2L', desc: '依序完成側面各層。'}, {name: '頂層', desc: '完成頂面星形與角塊。'}], videoId: '7Ron6MN45LY' },
  { id: 'pyraminx', title: '金字塔基礎解法', puzzle: 'Pyraminx', steps: [{name: '角塊', desc: '對齊四個角塊與中心。'}, {name: '底層', desc: '完成底面三個邊塊。'}, {name: '頂層', desc: '使用公式完成最後三個邊塊。'}], videoId: 'R0yOKEQCRMQ' },
  { id: 'sq1', title: 'Square-1 基礎解法', puzzle: 'Square-1', steps: [{name: '復原形狀', desc: '將魔方轉回正方體。'}, {name: '角塊分色', desc: '將上下層角塊顏色分開。'}, {name: '邊塊分色', desc: '將上下層邊塊顏色分開。'}, {name: '排列', desc: '完成上下層的角塊與邊塊排列。'}], videoId: '7Ron6MN45LY' },
  { id: 'skewb', title: '斜轉基礎解法', puzzle: 'Skewb', steps: [{name: '底層', desc: '完成底面四個角塊。'}, {name: '頂層角塊', desc: '將頂層四個角塊翻轉至正確方向。'}, {name: '中心塊', desc: '將剩餘中心塊歸位。'}], videoId: 'R0yOKEQCRMQ' },
  { id: '444bf', title: '4x4x4 盲解基礎', puzzle: '4x4x4 Blindfolded', steps: [{name: '中心記憶', desc: '使用 U2 法記憶 24 個中心塊。'}, {name: '邊塊記憶', desc: '使用 r2 法記憶 24 個邊塊。'}, {name: '角塊記憶', desc: '使用 OP 法記憶 8 個角塊。'}], videoId: '7Ron6MN45LY' },
  { id: '555bf', title: '5x5x5 盲解基礎', puzzle: '5x5x5 Blindfolded', steps: [{name: '中心與邊塊', desc: '分別記憶 +中心、X中心、中邊與翼邊。'}, {name: '執行', desc: '依序使用 U2/r2 等盲解公式執行。'}], videoId: 'R0yOKEQCRMQ' },
  { id: '333mbf', title: '多顆盲解基礎', puzzle: '3x3x3 Multi-Blind', steps: [{name: '記憶宮殿', desc: '在腦海中建立路線，將每顆魔方的編碼放進房間。'}, {name: '大量記憶', desc: '反覆複習確保不遺忘。'}, {name: '連續執行', desc: '戴上眼罩後一口氣復原所有魔方。'}], videoId: '7Ron6MN45LY' },
];
